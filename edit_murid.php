...
$sql = "SELECT * FROM murid WHERE id = ?";
...
<head>
    <meta charset="UTF-8">
    <title>Edit Murid - Sistem Surat PPD Besut</title>
...
<div class="container">
    ...
    <div class="page-header">
        ...
        <p>Kemaskini maklumat murid, urusan, pegawai penandatangan dan butiran surat.</p>
    </div>
    ...
    <div class="form-card">
        ...
        <form action="update_murid.php" method="POST">
            ...
            <div class="form-grid">
                <div class="form-group full">
                    ...
                    <input 
                        type="text" 
                        name="nama_penjaga" 
                        value="<?= htmlspecialchars($data['nama_penjaga']) ?>" 
                        required
                    >
                </div>
                ...
                <div class="form-group full">
                    ...
                    <input 
                        type="text" 
                        name="alamat_baris1" 
                        value="<?= htmlspecialchars($data['alamat_baris1']) ?>" 
                        required
                    >
                </div>
                ...
                <div class="form-group full">
                    ...
                    <input 
                        type="text" 
                        name="alamat_baris2" 
                        value="<?= htmlspecialchars($data['alamat_baris2']) ?>" 
                        required
                    >
            ...
            <div class="form-grid">
                <div class="form-group full">
                    ...
                    <input 
                        type="text" 
                        name="nama_murid" 
                        value="<?= htmlspecialchars($data['nama_murid']) ?>" 
                        required
                    >
                </div>
                ...
                <div class="form-group">
                    ...
                    <input 
                        ...
                        name="no_kp" 
                        id="no_kp"
                        value="<?= htmlspecialchars($data['no_kp']) ?>"
                        maxlength="14"
                        required
                    >
                    <div class="hint">Tarikh lahir dan darjah/tingkatan akan dikira semula jika No KP diubah.</div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input 
                        ...
                        name="darjah" 
                        id="darjah"
                        value="<?= htmlspecialchars($data['darjah']) ?>"
                    >
                ...
                <div class="form-group">
                    ...
                    <input 
                        type="text" 
                        name="sekolah_baru" 
                        value="<?= htmlspecialchars($data['sekolah_baru']) ?>"
                    >
                </div>
                ...
                <div class="form-group">
                    ...
                    <input 
                        type="text" 
                        name="sekolah_asal" 
                        value="<?= htmlspecialchars($data['sekolah_asal']) ?>"
                    >
                </div>
                ...
                <div class="form-group">
                    ...
                    <input 
                        type="date" 
                        name="tarikh_pertukaran" 
                        value="<?= $data['tarikh_pertukaran'] ?>"
                    >
                </div>
                ...
                <div class="form-group">
                    ...
                    <input 
                        ...
                        value="<?= htmlspecialchars($data['kewarganegaraan']) ?>"
                    >
                </div>
            ...
            <div class="button-row">
                ...
                <button type="submit" class="btn btn-primary">Update Rekod</button>
            </div>
